...
for (let i = 0; i < list_items.length; i++) {
	...
	for (let j = 0; j < lists.length; j++) {
		...
		list.addEventListener('dragenter', function (e) {
			e.preventDefault();
			this.style.backgroundColor = '#FFECA0';
		});
...
function changeImage() {
    ...
    if (image.src.match("on")) {
        image.src = "imagenes/tapamarilla.png";
    } else {
        image.src = "imagenes/boca.png";
    }
}
...
function changeImage2() {
    ...
    if (image2.src.match("on")) {
        image2.src = "imagenes/tapamarilla.png";
    } else {
        image2.src = "imagenes/mano.png";
...
function changeImage3() {
    ...
    if (image3.src.match("on")) {
        image3.src = "imagenes/tapamarilla.png";
    } else {
        image3.src = "imagenes/nariz.png";
    }
}
function changeImage4() {
    var image4 = document.getElementById('myImage4');
    if (image4.src.match("on")) {
        image4.src = "imagenes/tapamarilla.png";
    } else {
        image4.src = "imagenes/pie.png";
...
function changeImage5() {
    ...
    if (image5.src.match("on")) {
        image5.src = "imagenes/tapamarilla.png";
    } else {
        image5.src = "imagenes/ojo.png";
    }
}
function changeImage6() {
    var image6 = document.getElementById('myImage6');
    if (image6.src.match("on")) {
        image6.src = "imagenes/tapamarilla.png";
    } else {
        image6.src = "imagenes/oreja.png";
    }
}
