...
const quizQuestions = [{
        question: '¿Quién es el narrador de este cuento?',
        answers: [
            '<img src="imagenes/elprincipito.png" width="80px"> El Principito', '<img src="imagenes/aviador.png" width="70px"> El aviador'
        ],
        correctAnswer: '<img src="imagenes/aviador.png" width="70px"> El aviador'
    },
    {
        question: '¿Qué pensaba la gente adulta que era su dibujo de una boa?',
        answers: [
            '<img src="imagenes/sombrero.png" width="90px"> un sombrero', '<img src="imagenes/elefante.png" width="90px"> una boa que se come un elefante'
        ],
        correctAnswer: '<img src="imagenes/sombrero.png" width="90px"> un sombrero'
    },
    {
        question: '¿Dónde conoció el aviador al Principito?',
        answers: [
            'En una selva', 'En el desierto de Sahara'
        ],
        correctAnswer: 'En el desierto de Sahara'
    },
    {
        question: '¿El principito entendió el dibujo de la boa?',
        answers: [
    ...
    {
        question: 'Para un vanidoso, todas las otras personas son admiradoras.',
        answers: [
    ...
    {
        question: '¿Qué compraba el hombre del planeta 4?',
        answers: [
            '<img src="imagenes/aviones.png" width="80px">Aviones', '<img src="imagenes/estrellas.png" width="80px">Estrellas'
        ],
        correctAnswer: '<img src="imagenes/estrellas.png" width="80px">Estrellas'
    },
    {
        question: '¿Quién dice la frase: "Lo esencial es invisible a los ojos. Hay que mirar con el corazón." ?',
        answers: [
            '<img src="imagenes/elprincipito.png" width="80px"> El Principito', '<img src="imagenes/zorro.png" width="80px"> El zorro'
        ],
        correctAnswer: '<img src="imagenes/zorro.png" width="80px"> El zorro'
    }
];
...
function renderStartScreen() {
    $('main').append(`
	<h1 class='the-quiz-header'>El cuestionario a partir de la lectura de "El principito"</h1>
		<div id="centrado" class='start-screen'>
		<img src="imagenes/potadaprincipito.jpg" width="30%"><br/><br/>
		<a href="imagenes/principitolibro.pdf" download><button type="button" class="btn btn-primary btn-lg"><i class="fa fa-download"></i>Descargar cuento</button></a>
			</div>
			<br/>
