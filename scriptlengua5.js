...
const quizQuestions = [{
        question: '¿Los mitos y leyendas son historias fantásticas muy antiguas?',
        answers: [
    ...
    {
        question: '¿Quién era Acrisio?',
        answers: [
            '<img src="imagenes/rey.png" width="60px"> Un rey', '<img src="imagenes/sirviente.png" width="80px"> un sirviente'
        ],
        correctAnswer: '<img src="imagenes/rey.png" width="60px"> Un rey'
    },
    {
        question: '¿Cuántas hijas tenía Acrisio?',
        answers: [
            '1(una)', '2(dos)'
        ],
        correctAnswer: '1(una)'
    ...
    {
        question: '¿Acrisio quería a su nieto?',
        answers: [
            '<img src="imagenes/captura_tilde.png" width="70px"> SI', '<img src="imagenes/captura_mal.png" width="80px"> NO'
        ],
    ...
    {
        question: 'Finalmente ¿Perseo mató a Acrisio?',
        answers: [
            '<img src="imagenes/captura_tilde.png" width="70px"> SI', '<img src="imagenes/captura_mal.png" width="80px"> NO'
        ],
        correctAnswer: '<img src="imagenes/captura_tilde.png" width="70px"> SI'
    ...
    {
        question: '¿Ayuapati finalmente pudo tener una hija?',
        answers: [
            '<img src="imagenes/captura_tilde.png" width="70px"> SI', '<img src="imagenes/captura_mal.png" width="80px"> NO'
        ],
        correctAnswer: '<img src="imagenes/captura_tilde.png" width="70px"> SI'
    ...
    {
        question: '¿Satiavan y Savitri al final fueron reyes?',
        answers: [
            '<img src="imagenes/captura_tilde.png" width="70px"> SI', '<img src="imagenes/captura_mal.png" width="80px"> NO'
        ],
        correctAnswer: '<img src="imagenes/captura_tilde.png" width="70px"> SI'
    ...
    {
        question: 'En la isla Erín no vivía ningún demonio gigante.',
        answers: [
    ...
    {
        question: 'Cu Chulain y Emet se casaron.',
        answers: [
            '<img src="imagenes/captura_tilde.png" width="70px"> SI', '<img src="imagenes/captura_mal.png" width="80px"> NO'
        ],
        correctAnswer: '<img src="imagenes/captura_tilde.png" width="70px"> SI'
...
function renderStartScreen() {
    $('main').append(`
	<h1 class='the-quiz-header'>El cuestionario a partir de la lectura de "Mitos y leyendas del mundo"</h1>
		<div id="centrado" class='start-screen'>
		<img src="imagenes/mitosyleyendas.png" width="30%"><br/><br/>
		<a href="imagenes/mitosyleyendas.pdf" download><button type="button" class="btn btn-primary btn-lg"><i class="fa fa-download"></i>Descargar cuento</button></a>
			</div>
			<br/>
